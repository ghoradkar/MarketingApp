...
import 'package:marketingapp/runnerboy/sample_collection_history_details_screen.dart';
...
class SampleCollectionHistoryScreen extends StatefulWidget {
  final String empCode;

  const SampleCollectionHistoryScreen({super.key, required this.empCode});

  @override
  State<SampleCollectionHistoryScreen> createState() =>
      _SampleCollectionHistoryScreenState();
}

class _SampleCollectionHistoryScreenState
    extends State<SampleCollectionHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: CustomText(
          text: 'Sample Collection History',
          fontSize: 14.sp,
            ...
            decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    ...
                    blurRadius: 6,
                    offset: const Offset(
                        0, 0), // keep offset (0,0) for equal shadow
                  ),
                ]),
            child: Row(
              children: [
...
class _HistoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dayName =
        item.dayName ?? (date != null ? DateFormat('EEEE').format(date) : '');

    return GestureDetector(
      onTap: () => Get.to(() => SampleCollectionHistoryDetailsScreen(
            item: item,
            empCode: empCode,
          )),
      child: Card(
