...
ProfileBankDetailsModel profileBankDetailsModelFromJson(String str) => ProfileBankDetailsModel.fromJson(json.decode(str));

String profileBankDetailsModelToJson(ProfileBankDetailsModel data) => json.encode(data.toJson());

class ProfileBankDetailsModel {
    ProfileBankDetailsModel({
    ...
    factory ProfileBankDetailsModel.fromJson(Map<dynamic, dynamic> json) => ProfileBankDetailsModel(
